package io.datavines.notification.core.controller;
...
import io.datavines.notification.core.dto.bo.SlasCreate;
import io.datavines.notification.core.dto.bo.SlasSenderCreate;
import io.datavines.notification.core.dto.bo.SlasUpdate;
...
public class SlasController {
    ...
    @ApiOperation(value = "get sender param")
    @GetMapping(value = "/sender/support")
    public Object getSupportSender(){
    ...
    public Object getConfigJson(@PathVariable("type") String type){
        String json = slasService.getConfigJson(type);
        return json;
    }
