...
public enum ApiStatus {
    ...
    JOB_SCHEDULE_CRON_IS_INVALID_ERROR(14020004, "JobSchedule {0} Parameter is Null Error", "CRON表达式{0}无效的错误"),
    JOB_SCHEDULE_EXIST_ERROR(14020005, "Job Schedule {0} is Exist error", "作业定时任务 {0} 已存在错误"),
    CREATE_JOB_SCHEDULE_ERROR(14020006, "Create Job Schedule {0} Error", "创建作业定时任务 {0} 错误"),
    JOB_SCHEDULE_NOT_EXIST_ERROR(14020007, "Job Schedule {0} is not Exist error", "作业定时任务 {0} 不存在错误"),
    UPDATE_JOB_SCHEDULE_ERROR(14020008, "Update Job Schedule {0} Error", "更新作业定时任务 {0} 错误"),
