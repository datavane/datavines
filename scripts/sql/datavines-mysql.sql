...
CREATE TABLE `dv_catalog_schema_change` (
  ...
  `database_name` varchar(1024) DEFAULT NULL COMMENT '数据库',
  `table_name` varchar(1024) DEFAULT NULL COMMENT '表',
  `column_name` varchar(1024) DEFAULT NULL COMMENT '列',
...
CREATE TABLE `dv_job` (
  ...
  `schema_name` varchar(1024) DEFAULT NULL COMMENT '数据库名',
  `table_name` varchar(1024) DEFAULT NULL COMMENT '表名',
  `column_name` varchar(1024) DEFAULT NULL COMMENT '列名',
...
CREATE TABLE `dv_job_execution_result` (
  ...
  `metric_name` varchar(255) DEFAULT NULL COMMENT '规则名称',
  `database_name` varchar(1024) DEFAULT NULL COMMENT '数据库名称',
  `table_name` varchar(1024) DEFAULT NULL COMMENT '表名称',
  `column_name` varchar(1024) DEFAULT NULL COMMENT '列名称',
  `actual_value` double DEFAULT NULL COMMENT '实际值',
