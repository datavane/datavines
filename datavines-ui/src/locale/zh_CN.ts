export default {
    ...
    jobs_tabs_SLA: 'SLA配置',
    jobs_add_metirc: '添加作业',
    jobs_run_Profile: '运行配置文件',
    ...
    jobs_schedule_cronbtab: 'crontab调度',
    ...
    jobs_schedule_auto_generage: '自动生成的',
    jobs_Monday: '星期一',
    jobs_Tuesday: '星期二',
    jobs_Wednesday: '星期三',
    jobs_Thursday: '星期四',
    ...
    label_title: '标签分类',
    label_list: '标签列表',
    label_add_Classification: '新增标签分类',
    label_add: '新增标签',
    label_name: '标签名',
};
