...
@Slf4j
public class CatalogMetaDataFetchTaskImpl implements CatalogMetaDataFetchTask {
    ...
    public CatalogMetaDataFetchTaskImpl(MetaDataFetchRequest request) {
    ...
    private void executeFetchDataSource() throws SQLException {
        ...
        if (CollectionUtils.isNotEmpty(deleteDatabaseEntityList)) {
            deleteDatabaseEntityList.forEach(t -> {
                ...
                databaseDeleteChange.setDatabase(t.split("@@")[1]);
        ...
        if (CollectionUtils.isNotEmpty(createDatabaseEntityList)) {
            for (String database : createDatabaseEntityList) {
                ...
                if (!isFirstFetch) {
                    ...
                    databaseAddChange.setDatabase(databaseInfo.getName());
    ...
    private void executeFetchDatabase(String database) {
        ...
        if (CollectionUtils.isNotEmpty(deleteTableEntityList)) {
            deleteTableEntityList.forEach(t -> {
                ...
                tableDeleteChange.setDatabase(values[0]);
                tableDeleteChange.setTable(values[1]);
        ...
        if (CollectionUtils.isNotEmpty(createTableEntityList)) {
            for (String t : createTableEntityList) {
                ...
                if (!isFirstFetch) {
                    ...
                    tableAddChange.setDatabase(database);
                    tableAddChange.setTable(tableInfo.getName());
    ...
    private void addTableCommentChangeRecord(CatalogEntityInstance tableEntityInstance, String database, TableInfo tableInfo, String oldComment, String newComment) {
        ...
        tableCommentChange.setDatabase(database);
        tableCommentChange.setTable(tableInfo.getName());
    ...
    private void executeFetchTable(String database, String table) {
        ...
        if (CollectionUtils.isNotEmpty(deleteColumnEntityList)) {
            deleteColumnEntityList.forEach(t -> {
                ...
                columnDeleteChange.setDatabase(values[0]);
                columnDeleteChange.setTable(values[1]);
                columnDeleteChange.setColumn(values[2]);
        ...
        if (CollectionUtils.isNotEmpty(createColumnEntityList)) {
            for (String t : createColumnEntityList) {
                ...
                if (!isFirstFetch) {
                    ...
                    columnAddChange.setDatabase(database);
                    columnAddChange.setTable(table);
                    columnAddChange.setColumn(columnInfo.getName());;
    ...
    private void addColumnCommentChangeRecord(String uuid, String database, String table, String column, String oldComment, String newComment) {
        ...
        columnCommentChange.setDatabase(database);
        columnCommentChange.setTable(table);
        columnCommentChange.setColumn(column);
    ...
    private void addColumnTypeChangeRecord(String uuid, String database, String table, String column, String oldType, String newType) {
        ...
        columnTypeChange.setDatabase(database);
        columnTypeChange.setTable(table);
        columnTypeChange.setColumn(column);
