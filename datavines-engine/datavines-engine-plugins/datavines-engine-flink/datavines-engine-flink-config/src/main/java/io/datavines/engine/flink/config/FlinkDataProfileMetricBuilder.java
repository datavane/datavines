...
public class FlinkDataProfileMetricBuilder extends BaseFlinkConfigurationBuilder {
    ...
    public void buildSinkConfigs() throws DataVinesException {
        ...
        if (CollectionUtils.isNotEmpty(metricJobParameterList)) {
            for (BaseJobParameter parameter : metricJobParameterList) {
                ...
                String profileSinkSql = FlinkSinkSqlBuilder.getProfileValueSql().replace("${actual_value}",
