...
public class FlinkMultiTableValueComparisonMetricBuilder extends BaseFlinkConfigurationBuilder {
        ...
        if (CollectionUtils.isNotEmpty(metricJobParameterList)) {
            for (BaseJobParameter parameter : metricJobParameterList) {
                ...
                SinkConfig taskResultSinkConfig = getValidateResultDataSinkConfig(
                        null, FlinkSinkSqlBuilder.getMultiTableComparisonSinkSql(), "dv_job_execution_result", metricInputParameter);
    ...
    public java.util.Collection<String> getPluginNames() {
        return java.util.Collections.singletonList("flink_multi_table_value_comparison");
    }
}
